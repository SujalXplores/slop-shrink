...
/**
 * Themed wrapper over Base UI's Autocomplete — a text input with a filtered
 * suggestion list. The value is the input string, so it doubles as free-text
 * entry (a typed-but-unlisted model id still works).
 */
